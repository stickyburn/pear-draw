...
import { studio, glass, easings, durations, shadows, strokeColors } from "../styles/index.jsx";
  ...
  return (
    ...
    >
      ...
      >
          ...
          {(tool) => (
            <button
              ...
              style={{
                ...
                background: props.activeTool() === tool.id
                  ? `linear-gradient(135deg, ${studio.neon.violet} 0%, #7c3aed 100%)`
                  : hoveredTool() === tool.id
                    ? studio.surface
                    : "transparent",
                color: props.activeTool() === tool.id ? "white" : studio.text.secondary,
                border: "none",
                "border-radius": "12px",
                cursor: "pointer",
                transition: `all ${durations.fast} ${easings.spring}`,
                transform: hoveredTool() === tool.id && props.activeTool() !== tool.id ? "scale(1.08) translateY(-1px)" : "scale(1)",
                "box-shadow": props.activeTool() === tool.id
        ...
        <div style={{ height: "1px", background: studio.border, margin: "4px 0" }} />
            ...
            return (
              <button
                ...
                style={{
                  ...
                  "border-radius": "8px",
                  background: color,
                  border: props.strokeColor() === color
                    ? `2px solid ${studio.text.primary}`
                    : `1px solid ${studio.border}`,
                  cursor: "pointer",
                  transition: `all ${durations.fast} ${easings.spring}`,
                  transform: localHover() || props.strokeColor() === color ? "scale(1.15)" : "scale(1)",
                  "box-shadow": props.strokeColor() === color
      ...
      >
        <div style={{ display: "flex", "justify-content": "space-between", "align-items": "center" }}>
          <span style={{ "font-family": "var(--font-mono)", "font-size": "0.6rem", color: studio.text.muted, "letter-spacing": "0.1em", "text-transform": "uppercase" }}>Size</span>
          <span style={{ "font-family": "var(--font-mono)", "font-size": "0.75rem", color: studio.text.secondary, "font-weight": 500 }}>
            {props.strokeWidth()}<span style={{ color: studio.text.muted, "font-size": "0.6rem" }}>px</span>
          </span>
        </div>

        <div style={{ display: "flex", "justify-content": "space-between", "align-items": "center", background: studio.abyss, padding: "8px", "border-radius": "10px", border: `1px solid ${studio.border}` }}>
              ...
              >
                <div
                  style={{
                    ...
                    "border-radius": "50%",
                    background: props.strokeWidth() === size ? studio.neon.violet : studio.text.muted,
                    transition: `all ${durations.fast} ${easings.spring}`,
                    transform: props.strokeWidth() === size ? "scale(1.2)" : "scale(1)",
                    "box-shadow": props.strokeWidth() === size ? `0 0 12px ${studio.neon.violet}60` : "none",
                  }}
                />
                {props.strokeWidth() === size && (
                  <div style={{ position: "absolute", inset: "-3px", border: `1px solid ${studio.neon.violet}40`, "border-radius": "50%", animation: "studio-pulse-glow 2s infinite", "--glow-color": studio.neon.violet }} />
                )}
              </button>
            )}
          </For>
        ...
        <div style={{ position: "relative", padding: "4px 0" }}>
          <input
            ...
            style={{ width: "100%", cursor: "ew-resize", "-webkit-appearance": "none", appearance: "none", background: "transparent", height: "16px" }}
          />
          <style>{`
        ...
        <div style={{ height: "44px", background: studio.abyss, "border-radius": "10px", display: "flex", "align-items": "center", padding: "0 12px", overflow: "hidden", border: `1px solid ${studio.border}`, position: "relative" }}>
          <div style={{ position: "absolute", inset: 0, "background-image": `radial-gradient(circle, ${studio.border} 1px, transparent 1px)`, "background-size": "8px 8px", opacity: 0.5 }} />
          <div style={{ width: "100%", height: `${Math.min(28, props.strokeWidth())}px`, background: props.strokeColor(), "border-radius": "100px", transition: `all ${durations.fast} ${easings.spring}`, "box-shadow": `0 0 ${Math.min(24, props.strokeWidth())}px ${props.strokeColor()}50`, position: "relative", "z-index": 1 }} />
        </div>
      </div>
    </div>
  );
